...
for r in recov_epi:
	...
	plt.ylim([0, 30])
	plt.xlim([-1, 200])
	figname = 'Figures/epiOR_childrecov_time_%ssims_beta%.3f_recov%.1f_vax0.png' %(numsims, b, r)
	plt.savefig(figname)
	plt.close()
...
for r in recov_epi:
	...
	plt.ylim([0, 30])
	plt.xlim([-1, 200])
	figname = 'Figures/epiORfilt_childrecov_time_%ssims_beta%.3f_recov%.1f_vax0.png' %(numsims, b, r)
	plt.savefig(figname)
	plt.close()
	pp.compress_to_ziparchive(zipname, figname)
# 	plt.show()
...
for r in recov_epi:
	...
	plt.ylim([0, 30])
	plt.xlim([-1, 200])
figname = 'Figures/epiORfilt_childrecov_time_%ssims_beta%.3f_allrecov_vax0.png' %(numsims, b)
plt.savefig(figname)
plt.close()
pp.compress_to_ziparchive(zipname, figname)
# plt.show()
...
for r in recov_epi:
	...
	plt.xlim([-1, 200])
	figname = 'Figures/epiincid_childrecov_time_%ssims_beta%.3f_recov%.1f_vax0.png' %(numsims, b, r)
	plt.savefig(figname)
	plt.close()
	pp.compress_to_ziparchive(zipname, figname)
# 	plt.show()
...
figname = 'Figures/episize_childrecov_time_%ssims_beta%.3f_vax0.png' %(numsims, b)
plt.savefig(figname)
plt.close()
pp.compress_to_ziparchive(zipname, figname)
# plt.show()
