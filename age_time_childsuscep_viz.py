...
numsims = 30  # number of simulations
...
for s in susc_epi:
	...
	plt.ylim([0, 30])
	plt.xlim([-1, 200])
	figname = 'Figures/epiOR_childsusc_time_%ssims_beta%.3f_susc%.1f_vax0.png' %(numsims, b, s)
	plt.savefig(figname)
	plt.close()
...
for s in susc_epi:
	...
	plt.ylim([0, 30])
	plt.xlim([-1, 200])
	figname = 'Figures/epiORfilt_childsusc_time_%ssims_beta%.3f_susc%.1f_vax0.png' %(numsims, b, s)
	plt.savefig(figname)
	plt.close()
	pp.compress_to_ziparchive(zipname, figname)
# 	plt.show()
...
for s in susc_epi:
	...
	plt.ylim([0, 30])
	plt.xlim([-1, 200])
figname = 'Figures/epiORfilt_childsusc_time_%ssims_beta%.3f_allsuscep_vax0.png' %(numsims, b)
plt.savefig(figname)
plt.close()
pp.compress_to_ziparchive(zipname, figname)
# plt.show()
...
for s in susc_epi:
	...
	plt.xlim([-1, 200])
	figname = 'Figures/epiincid_childsusc_time_%ssims_beta%.3f_susc%.1f_vax0.png' %(numsims, b, s)
	plt.savefig(figname)
	plt.close()
	pp.compress_to_ziparchive(zipname, figname)
# 	plt.show()
...
figname = 'Figures/episize_childsusc_time_%ssims_beta%.3f_vax0.png' %(numsims, b)
plt.savefig(figname)
plt.close()
pp.compress_to_ziparchive(zipname, figname)
# plt.show()
