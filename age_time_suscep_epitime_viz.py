...
plt.xlim([1, 1.5])
plt.ylim([0, 0.9])
figname = 'Figures/HR-AR_susc_time_%ssims_beta%.3f_susc%.1f_vax0.png' %(numsims, b, s)
plt.savefig(figname)
plt.close()
...
# plt.ylim([0, 25])
# plt.xlim([1, 1.5])
# figname = 'Figures/totepiOR_susc_time_%ssims_beta%.3f_susc%.1f_vax0.png' %(numsims, b, s)
# plt.savefig(figname)
# plt.close()
# pp.compress_to_ziparchive(zipname, figname)
...
# plt.ylim([0, 5])
# plt.xlim([1, 1.5])
# figname = 'Figures/totepiOR-avgs_susc_time_%ssims_beta%.3fsusc%.1f_vax0.png' %(numsims, b, s)
# plt.savefig(figname)
# plt.close()
# pp.compress_to_ziparchive(zipname, figname)
# # plt.show()
